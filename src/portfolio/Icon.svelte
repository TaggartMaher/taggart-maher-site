<script lang="ts" module>
  ...
  const ICON_MARKUP: Record<IconName, string> = {
    folder:
      '<path d="M3 8a2 2 0 0 1 2-2h3l2 2h9a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />',
    person:
    ...
    lock: '<path d="M12 2a5 5 0 0 0-5 5v3H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2h-1V7a5 5 0 0 0-5-5zm-3 8V7a3 3 0 1 1 6 0v3z" />',
    document:
...
<script lang="ts">
  ...
  let { name, size = "1em", className }: IconProps = $props();
</script>
...
<svg
  ...
  class={className}
>
  <!-- Static, module-local SVG path strings — no user input. -->
  <!-- eslint-disable-next-line svelte/no-at-html-tags -->
  {@html ICON_MARKUP[name]}
</svg>
