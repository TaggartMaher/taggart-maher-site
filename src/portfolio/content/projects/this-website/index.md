...
![The desk scene blocked out in the Blender viewport](/projects/this-website/portfolio-site-viewport.png)
...
![Beauty pass preview in the viewport — screen emitter is off](/projects/this-website/portfolio-site-overlay-beauty-viewport.png)
...
![Position pass preview — the screen's UV gradient is visible as the colored grid](/projects/this-website/portfolio-site-overlay-position-viewport.png)
...
![The steam pass isolated in the Blender viewport](/projects/this-website/coffee-steam-viewport.png)

## The coffee steam shader

Here's the shader I made for the coffee steam. The tricky part was animating it such that it looped seamlessly. This was achieved via 2 separate noise textures which faded across each other so that the texture transformation (movement up, z axis, rising steam) did not "snap" every 2 seconds in the loop.

1. texture one goes up
2. texture 2 is also rising, but is not visible
3. as the animation comes to an end, texture 2 becomes visible
4. texture 1 is completely invisible, texture 2 has full alpha visibility
5. texture 2 is perfectly aligned at the start of where texture one was, same appearance as first frame.

![The shader graph driving the steam's emissive UV encoding](/projects/this-website/coffee-steam-shader.png)
